...
class Functions:
    '''
        Classe que representa funções matemáticas, a partir de um DataFrame
    ...
    def equacao_da_reta_calculo(
        ...
        '''
            ...
            da reta: y - y0 = m(x - x0), onde m é o coeficiente angular da
            reta formada pelos pontos mínimo e máximo das colunas x e y do
            DataFrame fornecido.
                Retorna:
                    float: valor de y para o dado x.
        '''
        a = self.__colunas_base()[0]
        b = self.__colunas_base()[1]
